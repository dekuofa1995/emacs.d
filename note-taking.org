                        ...
                        (cons #'tempel-comple
                              (company--multi-backend-adapter
                               (cape-company-to-capf
                                (company--multi-backend-adapter
                                 '(elpy-company-backend company-files company-dabbrev-code company-buffer-lines)))))))))
    :hook
     ((python-mode python-ts-mode) . elpy-enable)
    :hook (prog-mode . #'my/elpy-setup)

    ;; (add-hook 'python-mode #'my/elpy-setup)
    )
#+end_src

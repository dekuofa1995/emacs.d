...
*** Leader
- TODO ~meow-splice-sexp~ and ~meow-split-sexp~  [[w3m:https://github.com/Fuco1/smartparens/wiki/Working-with-expressions#manipulation-functions][document for meow-splice-sexp]]
...
| p   | project-find-file             |                     |
| q   | delete-window                 |                     |
| t   | meomacs-next-theme            |                     |
| T   | vterm                         |                     |
| j   | meow-join-sexp                |                     |
| w   | other-window                  |                     |
| W   | ace-window                    |                     |
| b b | consult-buffer                |                     |
| b s | consult-project-buffer        |                     |
| b w | consult-buffer-other-window   |                     |
